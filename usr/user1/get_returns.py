...
contributions = db.create_df(
    'outputs/daily_contributions_user1_AllAccounts.csv')
balance = db.create_df(
    'outputs/daily_acct_balance_user1_AllAccounts.csv')
col_contrb = 'Tot_Contributions_USD'
col_balance = 'Tot_Acct_Portfolio_USD'
col_return = 'Tot_Portfolio_Return_USD'
...
#########
# Save value to CSV
filename = 'outputs/returns_portfolio_user1_AllAccounts.csv'
